...
<body class="font-body text-bloopy-dark antialiased">
    ...
    <!-- Seção Hero -->
    <section id="home" class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-bloopy-blue">
        ...
        <div class="absolute bottom-20 right-10 w-48 h-48 bg-bloopy-yellow rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-float" style="animation-delay: 2s;"></div>
        ...
        <div class="absolute bottom-10 left-1/4 w-24 h-24 bg-bloopy-green rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-float" style="animation-delay: 3s;"></div>
        ...
        <!-- Onda separadora na base -->
        <div class="absolute bottom-0 w-full leading-none z-20">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-16 md:h-24 text-white fill-current">
